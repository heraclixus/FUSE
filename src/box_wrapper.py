...
from box_utils import log1mexp, ExpEi, reparam_trick, Bessel
tanh_eps = 1e-20
...
class BoxTensor(object):
    ...
    def _box_pool_layer(self: Type[TBoxTensor],
                  keys: TBoxTensor,
...
class DeltaExpBoxTensor(DeltaBoxTensor):
    """Same as Delta Box but the deltas are defined in logspace.
    z = w
    Z = w + exp(W)
    """
